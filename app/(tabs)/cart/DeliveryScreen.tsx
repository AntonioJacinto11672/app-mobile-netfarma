...
const DeliveryScreen = () => {
  ...
  return (
    <View className='bg-[#00665e]  flex-1'>
      <SafeAreaView className='z-50'>
        <View className='flex-row justify-between items-center p-5'>
          <TouchableOpacity onPress={() => router.replace("/cart")}>
            <XMarkIcon color={"white"} size={30} />
          </TouchableOpacity>
          <Text className='font-light text-white text-lg'>Ajuda para pedidos</Text>
        </View>
      ...
      <SafeAreaView className='bg-white flex-row items-center space-x-5 h-28'>
        ...
        <View className='flex-1'>
          ...
          <Text className='text-gray-400'> Teu entregador </Text>
        </View>

        <Text className='text-[#00665e] text-lg mr-5 font-bold'>Ligar 2</Text>
      </SafeAreaView>
    </View>
  )
}
